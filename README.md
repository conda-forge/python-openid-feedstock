...
pixi add python-openid
# for installing globally
pixi global install python-openid
```
...
It is possible to list all of the versions of `python-openid` available on your platform:
...
```
pixi search python-openid --channel conda-forge
```
